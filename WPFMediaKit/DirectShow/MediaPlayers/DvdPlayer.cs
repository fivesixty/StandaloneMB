...
namespace WPFMediaKit.DirectShow.MediaPlayers
{
    ...
    public class DvdPlayer : MediaSeekingPlayer
    {
        ...
        /// </summary>
        public string DvdDirectory { get; set; }
        ...
        private void BuildGraph()
        {
            try
            {
                ...
                m_renderer = CreateVideoRenderer(rendererType, m_graph);

                /* Do some VMR9 specific stuff */
                if (rendererType == VideoRendererType.VideoMixingRenderer9)
                {
                    var deinterlace = m_renderer as IVMRDeinterlaceControl9;

                    if (deinterlace != null)
                    {
                        /* Set our deinterlacing preferences */
                        /* Some DVDs flicker and look like shit if we dont do this */
                        deinterlace.SetDeinterlacePrefs(VMR9DeinterlacePrefs.BOB);
                        deinterlace.SetDeinterlaceMode(0, new Guid());
                    }
                }
                ...
                /* This gives us the DVD time in Hours-Minutes-Seconds-Frame time format */
                ...
                Guid[] preferedSubpictureTypes = new[]{MediaSubType.ARGB4444, 
                                                       MediaSubType.AI44, 
                                                       MediaSubType.AYUV, 
                                                       MediaSubType.ARGB32};
