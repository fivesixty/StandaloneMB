...
namespace WPFMediaKit.DirectShow.MediaPlayers
{
    ...
    /// </summary>
    [ComVisible(true)]
    public class Vmr9Allocator : DispatcherObject, IVMRSurfaceAllocator9, IVMRImagePresenter9, ICustomAllocator
    {
        /// <summary>
        /// Direct3D functions
        /// </summary>
        ...
        /// </summary>
        /// <param name="hWnd">A valid hWnd to supply to D3D</param>
        public Vmr9Allocator(IntPtr hWnd)
        {
        ...
        protected virtual void Dispose(bool disposing)
        {
            ...
            if (disposing)
            {
                ...
                /* Free D3D Device stuffs */
                if (m_device != null)
                    Marshal.ReleaseComObject(m_device);

                m_device = null;

                /* Free any other unmanaged stuffs */
                if (m_d3d != null)
                    Marshal.ReleaseComObject(m_d3d);

                m_d3d = null;

                /* This will only be non null on Vista or better */
                if (m_d3dEx != null)
                    Marshal.ReleaseComObject(m_d3dEx);

                m_d3dEx = null;

                if (m_allocatorNotify != null)
                    Marshal.ReleaseComObject(m_allocatorNotify);
            }
